    ...
    launchChat = event => {
        ...
        if (userId === null || userId.trim() === "") {
            ...
            .then(() => {
                ...
                instanceLocator: "v1:us1:e81619c7-8f4f-42f1-a305-935c962834de",
                userId,
                tokenProvider
                });
                ...
                return chatManager.connect().then(currentUser => {
                    this.setState(
                        {currentUser,isLoading: false},() => this.createRoom()
                    );
                });
            })
            .catch(console.error);
    ...
    render() {
        ...
        return (
            ...
            {currentRoom ? (
                ...
                <button onClick={this.showDialog} className="contact-tn">
                Contact Support
                </button>
            )}
